...
(fn &optional TITLE KEYWORDS FILE-TYPE SUBDIRECTORY DATE TEMPLATE)" t)
...
(fn FILE TITLE KEYWORDS &optional DATE)" t)
...
- if the file is recognized as a Denote note, add a front matter
  ...
  the user option `denote-file-type')." '(dired-mode))
...
their respective front matter." '(dired-mode))
...
Like `denote-link-find-file', but select backlink to follow." t)
...
Insert new Org dynamic block to include backlinks." t)
