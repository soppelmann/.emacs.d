...
With prefix ARG, enable Global Nlinum mode if ARG is positive; otherwise,
disable it.
...
Nlinum mode is enabled in all buffers where `(lambda nil (unless (minibufferp)
(nlinum-mode)))' would do it.
